        ...
        if(this.spell == 1072 || this.spell == 1073) {//glyph pair/impair
            if(target.getMob() != null) {
                if(target.getMob().getTemplate().getId() == 1045) {
                    if(this.spell == 1072) {
                        target.addBuff(217, 400, 2, false, 1077, "", target);// - 400 air
                        target.addBuff(218, 400, 2, false, 1077, "", target);// - 400 feu
                        ...
                        target.addBuff(215, 400, 2, false, 1077, "", target);// - 400 terre
                        target.addBuff(216, 400, 2, false, 1077, "", target);// - 400 eau
