...
function npc:onTalk(p, answer)
    ...
    elseif answer == 2026 then p:ask(2398, {2029, 2030, 2031, 2032, 2033, 2097, 2034})
    elseif answer == 2097 then p:ask(2446, {2095, 2096, 2099, 2100, 2098})
    elseif answer == 2098 then p:ask(2398, {2029, 2030, 2031, 2032, 2033, 2097, 2034})
    ...
    elseif answer == 1972 then p:ask(2371, {2068})
    elseif answer == 2068 then p:compassTo(7362) p:endDialog()
    end
end
